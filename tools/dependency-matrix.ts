...
export default tool({
  description: "Extract import/use relationships, detect circular dependencies, compute fan-in/fan-out",
  args: {
  ...
  async execute(args, context) {
    ...
    const script = path.join(scriptsDir, "dependency-matrix.py");
    try {
